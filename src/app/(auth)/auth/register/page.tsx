...
import { Eye, Lock, Mail, Terminal, User } from "lucide-react";
import Link from "next/link";
import { signupAction } from "./_actions/SingupAction";
            ...
            <form action={signupAction} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 size-3.5 text-zinc-500 pointer-events-none" />
                  <Input
                    id="name"
                    name="name"
                    type="text"
